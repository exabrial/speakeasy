...
public class EccEncrypterTest {
  ...
  public void testEncrypt() {
    ...
    final ECIESEncrypter ecc = new ECIESEncrypter(keyPair.getPublicKey());
    final String output = ecc.encrypt("plainText");
    System.out.println(output);
    final ECIESDecrypter dcc = new ECIESDecrypter(keyPair.getPrivateKey());
